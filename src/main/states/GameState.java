		...
		KeyListener kl = new KeyListener() { //Define an implementation of KeyListener
		   ...
		   @Override
		    ...
		    public void keyPressed(int key, char c) {
		    	...
		    	case Input.KEY_LEFT: r.getObjects()[0].moveLeft(); break;
		    	case Input.KEY_D: r.getObjects()[0].moveRight(); break;
		    	case Input.KEY_RIGHT: r.getObjects()[0].moveRight(); break;
		    	...
		    	case Input.KEY_UP: r.getObjects()[0].tryJump(r.getGravityDir()); break;
		    ...
		    public void keyReleased(int key, char c) {
		    	...
		    	case Input.KEY_LEFT: r.getObjects()[0].stopLeft(); break;
		    	case Input.KEY_RIGHT: r.getObjects()[0].stopRight(); break;
		    	default: break;
		    	}
		    }
		  }.init(game);
